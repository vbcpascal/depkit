...
namespace depkit
{
	...
	z3::expr CodeGenZ3::Visit(PackageExprAtomWithNamePtr& e)
	{
		// z3 in dependencies of llvm -> assert(=> llvm z3)
		return get_pack(e->pack_name_).package_;
	}

	z3::expr CodeGenZ3::Visit(PackageExprAtomWithPropPtr& e)
	{
		...
		case AtomType::NIN:
			...
			if (prop_name == "backend")
			{
				...
				if (e->type_ == AtomType::IN) return p && res;
				else return p && !res;
			}
	...
	z3::expr CodeGenZ3::Visit(PackageExprUnaryPtr& e)
	{
	...
	z3::expr CodeGenZ3::Visit(PackageExprBinaryPtr& e)
	{
	...
	z3::expr CodeGenZ3::Visit(IfPackagePtr& e)
	{
	...
	z3::expr CodeGenZ3::Visit(IfElsePackagePtr& e)
	{
		auto cond = Visit(e->cond_);
		auto body = Visit(e->body_);
